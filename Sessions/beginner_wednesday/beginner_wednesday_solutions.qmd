...
# read in one object
f1_sobj <-
    qs_read("workshop_data/rdata/f1_sobj_processed_annotated.qs2")
f1_sobj
#list of Seurat objects from the same experiment (GSE232482)
GSE232482_sobj_list <-
    qs_read("workshop_data/rdata/GSE232482_object_list_processed_annotated.qs2")
GSE232482_sobj_list
...
qs::qsave(merged_GSE232482_sobj,
          "workshop_data/rdata/merged_GSE232482_sobj.qs2")
...
qs::qsave(merged_sobj,
          "workshop_data/rdata/merged_sobj.qs2")
...
merged <- qread("workshop_data/rdata/merged_sobj_before_harmony.qs2")
```
