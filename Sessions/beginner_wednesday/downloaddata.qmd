...
ctx_obj <-
    CreateSeuratObject(
    counts = t(as.matrix(read_h5ad("input/scRNA/WMB-10Xv2-CTXsp-raw.h5ad"))),
    meta.data = ctx$obs,
    min.features = 200,
    min.cells = 3,
    project = "CTX"
...
```{r}
# Process MB object
mb <- read_h5ad("input/scRNA/WMB-10Xv2-MB-raw.h5ad")
...
```{r}
hy <- read_h5ad("input/scRNA/WMB-10Xv2-HY-raw.h5ad")
...
```{r}
th <- read_h5ad("input/scRNA/WMB-10Xv2-TH-raw.h5ad")
