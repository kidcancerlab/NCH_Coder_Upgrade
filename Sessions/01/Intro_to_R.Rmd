...
Create two character variables containing values "5" and "10", respectively. Make sure to wrap the variables in quotes. 
...
Create a set of factor variables containing the following values: , Specify the correct order. 
...
### join -- left_join, inner_join, right_join, outer_join, anti_join
