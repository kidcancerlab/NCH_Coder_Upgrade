...
There are a few rules for naming variables in R. If possible names should be short and meaningful, and should include numbers, letters, _, and -. Avoid using special characters in names. Also, R is case-sensitive. 
