...
Create a new Rmd file. Use ctrl+shift+i to insert a new R chunk.
...
Packages are created by the commnunity and so conventions and quality vary widely.
...
summarize() summarizes data within groups in a data frame. This makes a new column and drops all unnecesary columns.
```{r}
westernQuant %>%
  group_by(group_name) %>%
...
### Read in our data
We have two tables of data:
- weather_temps.txt
    - Has monthly average temperatures for cities around the world
- weather_precip.txt
    - Has monthly average precipitation for cities around the world
```{r}
