...
\visible<1-6>{\put(200, 145){\includegraphics[height=1.25in]{images/shared_mem.jpg}}}
\visible<4-6>{\put(165, 50){\includegraphics[height=0.95in]{images/distributed_mem.jpg}}}
