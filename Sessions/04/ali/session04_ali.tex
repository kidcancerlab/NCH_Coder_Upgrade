...
\visible<4>{\put(165, 50){\includegraphics[height=2.20in]{images/franklin_face.pdf}}}
...
\frametitle{Why use a supercomputer?}
\begin{picture}(320,250) 
\visible<2-4>{\put(190, 60){\includegraphics[height=2.2in]{images/franklin_face.pdf}}}
