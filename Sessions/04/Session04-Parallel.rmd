...
# that have been allotted to you through the scheduler (slurm)
...
single_op <- function(x) {
    message("One of the processes is starting...")
    create_seurat(x)
    message("One of the processes is transitioning to the second stage...")
    process_seurat(x)
    message("One of the processes has completed.")
    return(x)
}
...
# Map the function using mclapply
tumors_parallel <- slurm_map(tumors_serial, process_seurat, mc.cores = 10L)
