...
### Create a pseudobulk dataset for *anchor_cell_types* and *age* (note: you might have to explore the help page for FindMarkers to see how to navigate the error message)
```{r}
