...
Plot the expression of these regions in the original object, using the ATAC reduction

```{r}
FeaturePlot(activity_ob, features = top_10_each$gene, reduction = "umap_atac")
```
