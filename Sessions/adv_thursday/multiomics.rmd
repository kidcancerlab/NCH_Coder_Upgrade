...
3.1 Read in the object `input/multiomics/activity_data/activity_small.qs`. This is the object from before, downsampled to only contain cells in ATAC clusters 0 and 1. Find the top 5 differentially accessibile peaks between the two groups as determined by log-fold change
