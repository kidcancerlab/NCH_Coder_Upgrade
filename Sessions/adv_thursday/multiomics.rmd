...
ATAC seq has similar QC metrics to RNA seq, as well as some additional metrics that are we don't see in RNA. Therefore we're going to introduce these metrics one by one before we filter out any cells.
