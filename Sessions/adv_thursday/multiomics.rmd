...
NEED TO ADD IN ACTIVITY!! HERE'S WHAT I'M THINKING
    - have them read in a new (smaller ~1500 cells) dataset
    - have them create a chromatin assay object and make a seurat object
    - Have them add in cellranger metadata
    - Have them set gene annotations
...
Now take object from first activity and run QC steps and processing steps.
...
### Matching cells between datasets (Do we need this?)
