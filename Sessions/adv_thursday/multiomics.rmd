...
annotations <- qs2::qs_read("~/workshop_data/rdata/annotations.qs2")
...
qs_save(
    small_obj,
    "Sessions/adv_thursday/small_obj_linked.qs2"
)
...
qs_save(freq_matrix, "~/workshop_data/rdata/freq_matrix.qs2")
# This takes a while, so lets read in the pre-made object

freq_matrix <- qs2::qs_read("~/workshop_data/rdata/freq_matrix.qs2")
...
qs2::qs_save(small_obj, "~/workshop_data/rdata/multiomics_small_obj_motifs.qs2")
# This takes a while, so lets read in the pre-made object

small_obj <-
    qs2::qs_read("~/workshop_data/rdata/multiomics_small_obj_motifs.qs2")
