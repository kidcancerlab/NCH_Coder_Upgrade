...
qs::qsave(nichenet_stepwise_output, file = "Sessions/06/nichenet_stepwise_output.qs")
```
...
qs::qsave(nichenet_easy_output, file = "Sessions/06/nichenet_easy_output.qs")
```
...
```{r}
tumor_h <- qs::qread("os_shark_400.qs")
```
