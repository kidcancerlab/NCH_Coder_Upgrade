...
Potential_ligands_PearsonCut <- nichenet_easy_output$ligand_activities %>% filter (pearson >0.004) %>% pull(test_ligand)
...
Potential_ligands_PearsonCut_activity <- nichenet_easy_output$ligand_activities %>% 
...
nichenet_selected_ligand_link_PearsonCut<-     
    nichenet_easy_output$ligand_target_matrix[rownames(nichenet_easy_output$ligand_target_matrix)%in%Potential_ligands_PearsonCut,]
