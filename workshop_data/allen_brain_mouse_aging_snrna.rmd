...
```{bash allen_download}
wget \
    -O input/scRNA/be390e1d-1412-454f-aa8f-925ca3beacff.rds \
...
allen <-
  readRDS("input/scRNA/be390e1d-1412-454f-aa8f-925ca3beacff.rds")
allen$ID <-
...
# save object
qsave(allen,
      "input/scRNA/allen_brain_mouse_aging_snrna.qs")
```
